...
public class AddAnimalEvent extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final String[] events = new String[]{
                getString(R.string.heat_detection),
                getString(R.string.serves),
                getString(R.string.weight_check)
        };
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(eventDateEditText.getText().toString().trim())) {
                    TastyToast.makeText(
                            getActivity(),
                            getString(R.string.enter_event_date),
                    ...
                    TastyToast.makeText(
                            getActivity(),
                            getString(R.string.enter_event_name),
                            TastyToast.LENGTH_LONG,
                            TastyToast.ERROR
                    );
                } else {
